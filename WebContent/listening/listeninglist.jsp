...
<body>
	<form method="post" action="" id="listform">
		<div class="panel admin-panel">
			...
			<div class="padding border-bottom">
				<ul class="search" style="padding-left: 10px;">
					<li><a class="button border-main icon-plus-square-o"
						href="${ctx }/listening/addlistening.jsp"> 添加听力题</a></li>
					<li>搜索：</li>
					<li>
			...
			<table class="table table-hover text-center">
				...
				<tr>
				<c:forEach items="${page.list }" var="listen">
			        <tr>
						<td style="text-align:left; padding-left:20px;"><input type="checkbox" name="id[]" value="" />
			           ${listen.parentQuestionId}</td>
			        	<td> 
				...
				<tr>
					<td colspan="8"><div class="pagelist">
						<a href="${ctx }/listening/list?pageNum=1">首页</a> 
			         <a href="${ctx }/listening/list?pageNum=${page.prePageNum }">上一页</a>
			        	...
			        	<c:forEach begin="1" end="${page.totalPageNum }" var="pageNum">
			        		<c:choose>
							   ...
							   <c:otherwise> 
							    <a name="pagen" href="${ctx }/listening/list?pageNum=${pageNum }">${pageNum }</a>
							   </c:otherwise>
							</c:choose>
						</c:forEach>
						
						<a href="${ctx }/listening/list?pageNum=${page.nextPageNum }">下一页</a>
			        	 <a href="${ctx }/listening/list?pageNum=${page.totalPageNum }">尾页</a> 
	...
	function searchp(){
		...
		window . location . href = "${ctx }/listening/list?searchParam="+p;
	}
