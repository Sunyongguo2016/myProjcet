...
<body>
		...
		<div class="panel admin-panel">
			...
			<div class="padding border-bottom">
				<ul class="search" style="padding-left: 10px;">
					...
					<li><input id="searchParam" type="text" placeholder="请输入搜索名称" " name="" value="${searchParam }" class="input" style="width:250px; line-height:17px;display:inline-block" />
	...
	function searchp(){
		...
		window . location . href = "${ctx }/quickreading/list?searchParam="+p;
	}
