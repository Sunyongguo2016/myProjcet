    ...
    <body>
     <!-- header-->
        ...
        <div class="breadcrumb">
            <a href="${ctx }/index_before.jsp">首页</a>>>错题本列表
        </div>
        <!--左侧边栏-->
        <div class="left">
            <h2>错题本</h2>
            <div class="vtitle"><a href="${ctx }/wrongpage/wrongpagelist.jsp">我的错题本</a></div>
                <div class="vcon" style="display: none;">
            </div>
            <div class="vtitle"><a href="${ctx }/wrongpage/wrongpagelist.jsp">我的收藏</a></div>
                <div class="vcon" style="display: none;">
            </div>
            <div class="vtitle"><a href="${ctx }/wrongpage/wrongpagelist.jsp">我的收藏</a></div>
                <div class="vcon" style="display: none;">
        ...
        <div class="right">
            ...
            <div class="right_content" style="line-height:40px;">
                <div class="wenzhang_content">
                        <ul>
                            <a href="${ctx }/wrongpage/wrongpage.jsp"><li>世界<hr style="border:1px dashed grey;"/></li></a>
                            <a href="${ctx }/wrongpage/wrongpage.jsp"><li>世界<hr style="border:1px dashed grey;"/></li></a>
                            <a href="${ctx }/wrongpage/wrongpage.jsp"><li>世界<hr style="border:1px dashed grey;"/></li></a>
                            <a href="${ctx }/wrongpage/wrongpage.jsp"><li>世界<hr style="border:1px dashed grey;"/></li></a>
                            <a href=""><li>世界<hr style="border:1px dashed grey;"/></li></a>
                            <a href=""><li>世界<hr style="border:1px dashed grey;"/></li></a>
                            <a href=""><li>世界<hr style="border:1px dashed grey;"/></li></a>
                            <a href=""><li>世界<hr style="border:1px dashed grey;"/></li></a>
                        </ul>
