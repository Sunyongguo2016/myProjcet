                                        	...
                                        	<tr>
                                            	<td colspan="2">
                                                        <ul>
                                                            ...
                                                            <li><label><input type="radio" class="validate[required] qk-choice" value="${select.selecttName}" data-qid="${question.questionId}" name="Q-${question.questionId}"/>
		                                            ...
		                                            <tr>
		                                            	<td colspan="2">
			                                            	<c:forEach items="${parentQuestion.questions}" var="qust" varStatus="status">
			                                            		...
			                                            		class="validate[required] tm_txt qk-blank" style="width:100px;"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		                                    					<c:if test="${status.count % 5 == 0}">
		                                    						<br/><br/>
		                                    					</c:if>
		                                    				</c:forEach>
                                    	...
                                    	<c:when test="${parentQuestion.parentQuestionName=='QuickReading'}">
                                            ...
                                            <c:forEach items="${parentQuestion.questions}" var="qust">
			                                    ...
			                                    <table border="0" cellpadding="0" cellspacing="0" class="tm_paper_question" style="table-layout:fixed;">
			                                    	<thead>
			                                        	<tr>
			                                                <td colspan="2" class="tm_question_lineheight" style="font-size:14px; width:900px;">
																&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;${qust.questionContent}&nbsp;&nbsp;<input type="text" name="Q-${qust.questionId}" 
																data-qid="${qust.questionId}" class="validate[required] tm_txt qk-blank" style="width:35px;"/>                                          
															</td>
			                                            </tr>
			                                        </thead>
			                                        <tbody>
