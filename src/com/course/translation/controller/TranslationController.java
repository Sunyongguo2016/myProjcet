...
/**
 * 
 * @Description 		大题翻译控制器  实现增加   删除  查看(list)功能
 * @author 				孙晓辉
...
public class TranslationController {
	...
	/**
	 * 
	 * @desc				添加翻译大题，获取addtranslation.jsp的参数，实现添加parentQuestion对象；
	 * @author				孙晓辉
	...
	/**
	 * 
	 * @desc				删除翻译大题，获取translationlist.jsp的参数，实现删除parentQuestion对象；
	 * @author				孙晓辉
	 * @createDate 			2016/11/21
	 * @param 				获得删除翻译大题相关参数
	 * @return				String
	...
	/**
	 * 
	 * @desc				查看翻译大题，获取translationlist.jsp的参数，实现分页和搜索
	 * @author				孙晓辉
	 * @createDate 			2016/11/21
	 * @param 				获得查看翻译大题相关参数
	 * @return				String
	...
	public String list(@RequestParam(name = "pageNum", defaultValue = "1") int pageNum,
			...
			@RequestParam(name = "parentQuestionName", defaultValue = "Translation") String parentQuestionName,
